...
<html lang="en">
<head>
    <title>Code coverage report for node-htmlprocessor/lib/htmlprocessor.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-htmlprocessor/lib/htmlprocessor.js</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(50 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">92.31% <small>(12 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(12 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(50 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">node-htmlprocessor/lib/</a> &#187; htmlprocessor.js</div>
</div>
<div class="body">
...
HTMLProcessor.prototype.processContent = function (content, filepath) {
  ...
  this.linefeed = /\r\n/g.test(this.content) ? <span class="branch-0 cbranch-no" title="branch not covered" >'\r\n' </span>: '\n';
&nbsp;
